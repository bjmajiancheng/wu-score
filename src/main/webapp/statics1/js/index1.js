...
$('.menuCard>p').click(function () {
    ...
    if (clickNum == 0) {
        ...
        $(this).attr({'isclick': '1'});
        $(this).find('p.fl').attr('style', "color:rgb(243, 127, 50);background: rgb(221, 230, 237);");
        ...
        $(this).find('p.fl').removeAttr('style', "color:rgb(243, 127, 50);background: rgb(221, 230, 237);");
        $(this).attr({'isclick': '0'});
    }
});
