...
jQuery.validator.addMethod("isAge",function(value,element){
    return this.optional(element) || (/^\d+$/.test(value) && value < 200)
},"请输入正确的年龄");

// 身份证号码验证
jQuery.validator.addMethod("isIdCardNo", function(value, element) {
    var pattern = /(^\d{18}$)|(^\d{17}(\d|X|x)$)/;
    return this.optional(element) || (pattern.test(value) && isIdCardNo(value));
}, "请输入正确的身份证号码");


// 电话号码验证
jQuery.validator.addMethod("isPhone", function(value, element) {
    var tel = /^([0-9]{3,4}-)?[0-9]{7,8}$/g;
    return this.optional(element) || (tel.test(value));
}, "请输入正确的电话号码");


// 姓名验证
jQuery.validator.addMethod("isUserName2", function(value, element) {
    var userName = /^[\u4e00-\u9fa5]{2,4}$/g;
    return this.optional(element) || (userName.test(value));
}, "请输入正确的姓名");

// 姓名验证2，可以输入除了数字之外的任何字符
jQuery.validator.addMethod("isUserName", function(value, element) {
    var userName = /^\D{2,30}$/g;
    return this.optional(element) || (userName.test(value));
}, "请输入正确的姓名");
